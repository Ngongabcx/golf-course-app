...
import 'package:gcms/app/modules/ScoresInputScreen/controllers/result_calculation.dart';
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: CircleImage(
                        imageProvider: AssetImage('images/Tiger-Woods.jpg'),
                      ),
                    ),
                    Text(
                      'Tiger Woods',
                  ...
                  children: [
                    ...
                    Expanded(
                      ...
                      child: Column(
                        children: [
                          RoundButtonWidget(
                            text: controller.stroke.toString(),
                            style: Theme.of(context).textTheme.bodyText2,
                          ),
                          Padding(
                            padding: const EdgeInsets.all(16.0),
                ...
                Padding(
                  padding:
                      const EdgeInsets.only(top: 0.0, right: 16.0, bottom: 8.0),
                  child: Row(
                    children: <Widget>[
                      Expanded(
                        flex: 4,
                ...
                Column(
                  children: [
                    SubmitButton(
                      ...
                      onPressed: () {
                        ResultCalculation resultCalc = ResultCalculation(
                            controller.hcp,
                            controller.par,
                            controller.stroke,
                            controller.score);
