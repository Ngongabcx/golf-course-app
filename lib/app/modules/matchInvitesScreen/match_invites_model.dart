...
MatchInvites matchInvitesFromJson(String str) =>
    MatchInvites.fromJson(json.decode(str));
...
enum PlayerAddress { NDOLA, CHIWALA, IBEX_HILL }
...
final emailValues =
    EnumValues({"chainama@gmail.com": Email.CHAINAMA_GMAIL_COM});

enum Username { LEONARD_CHINYAMA, NICK_NICK_COM, BWALYANGONGA_GMAIL_COM }
...
enum DateJoined {
  THE_3202021120000_AM,
  THE_3152021120000_AM,
  THE_11182021120000_AM
}
...
final dobValues =
    EnumValues({"3/19/2021 12:00:00 AM": Dob.THE_3192021120000_AM});

enum Stname { CHINYAMA, NICK, BWALYA }
...
final nameValues = EnumValues(
    {"Normal User": Name.NORMAL_USER, "Stable Ford": Name.STABLE_FORD});
...
final courseAddressValues =
    EnumValues({"Plot 1 Chainama": CourseAddress.PLOT_1_CHAINAMA});

enum CourseAbr { CHA_1 }

final courseAbrValues = EnumValues({"Cha-1": CourseAbr.CHA_1});

enum CourseName { CHAINAMA_GOLF_CLUB }

final courseNameValues =
    EnumValues({"Chainama Golf Club": CourseName.CHAINAMA_GOLF_CLUB});
